all: smtlibparser.yy smtlibscanner.l
	...
	$(CXX) -static -std=c++11 -I./local/include/ -L./local/lib/ smtlibparser.cpp smtlibscanner.cpp smtlib_driver.cpp smt-switch-parser-cvc4.cpp -o smt-switch-parser-cvc4 -lfl -lsmt-switch-cvc4 -lsmt-switch -lgmp
