...
./configure.sh --bitwuzla --python --python-executable=$(which python3)
cd build
make -j
echo "DEBUG smt_switch contents before"
ls ./python/smt_switch
...
echo "DEBUG smt_switch contents after"
ls ./python/smt_switch