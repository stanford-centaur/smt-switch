 ...
 */
void PortfolioSolver::run_solver(SmtSolver s, Term t)
{
 ...
 */
smt::Result PortfolioSolver::portfolio_solve(std::vector<SmtSolver> solvers,
                                             Term t)
{
  ...
  for (auto s : solvers)
  {
    ...
    std::thread t1(&PortfolioSolver::run_solver, this, s, t);
